...
<body>
    ...
    <section class="Dv-slider">
        <img src="{{asset('frontend/asset/images/dx-718-1.jpg')}}" alt="">
    </section>
    ...
    <main>
        ...
        <!-- <section class="car-dx-content">
            ...
            <div class="car-dx-content-items">
                ...
                <div class="car-dx-content-item">
                    <img src="{{asset('frontend/asset/images/car-dx3.png')}}" alt="">
                    <Li>718 Boxster</Li>
                    <li style="margin-top: 5px;">Giá tiêu chuẩn: 3.960.000.000 VNĐ*</li>
                    <li style="margin-top: 20px;"><button><i class="ri-arrow-right-wide-line"></i><a
                                href="http://127.0.0.1:8000/kp718-1">Khám phá</a></button></li>
                    <li><button style="margin-top: 3px;"><i class="ri-shopping-cart-line"></i>Thêm giỏ hàng</button>
                    </li>
                  ...
                  @endforeach
                <div class="car-dx-content-item">
                    <img src="{{asset('frontend/asset/images/car-dx2.png')}}" alt="">
                    <Li>718 Cayman S</Li>
                    <li style="margin-top: 5px;">Giá tiêu chuẩn: 4.770.000.000 VNĐ*</li>
                    <li style="margin-top: 20px;"><button><i class="ri-arrow-right-wide-line"></i><a
                                href="http://127.0.0.1:8000/kp718-4">Khám phá</a></button></li>
                    <li><button style="margin-top: 3px;"><i class="ri-shopping-cart-line"></i>Thêm giỏ hàng</button>
                    </li>
        ...
        <section class="car-dx-content">
            ...
            <div class="car-dx-content-items">
                ...
                <div class="car-dx-content-item">
                  ...
                  @endforeach
                <div class="car-dx-content-item">
                    <img src="{{asset('frontend/asset/images/dx-718-3.png')}}" alt="">
                    <Li>718 Boxster Style Edition</Li>
                    <li style="margin-top: 5px;">Giá tiêu chuẩn: 4.380.000.000 VNĐ*</li>
                    <li style="margin-top: 20px;"><button><i class="ri-arrow-right-wide-line"></i><a
                                href="http://127.0.0.1:8000/kp718-6">Khám phá</a></button></li>
                    <li><button style="margin-top: 3px;"><i class="ri-shopping-cart-line"></i>Thêm giỏ hàng</button>
                    </li>
